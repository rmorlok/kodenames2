...
// Based on https://github.com/prescottprue/react-google-button
...
export const darkStyle: CSSProperties = {
    backgroundColor: '#4285f4',
    color: '#fff',
    ...baseStyle
}

export const lightStyle: CSSProperties = {
    backgroundColor: '#fff',
    color: 'rgba(0,0,0,.54)',
    ...baseStyle
}
...
type GoogleIconProps = {
    ...
    readonly type: LightOrDark
};

export const GoogleIcon = ({disabled, type}: GoogleIconProps) => (
...
export const GoogleSignInButton = (p: Partial<GoogleButtonProps>) => {
    const defaults: GoogleButtonProps = {
    ...
    const getStyle = (): CSSProperties => {
        ...
        if (hovered) {
            return { ...baseStyle, ...hoverStyle, ...props.style }
        }
        if (props.disabled) {
            return { ...baseStyle, ...disabledStyle, ...props.style }
        }
